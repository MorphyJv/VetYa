import { getDiaryNote } from "../../diaryActions";
import DiaryEditorClient from "./DiaryEditorClient";
import Link from "next/link";
import { createClient } from "@/lib/supabase/server";
import { redirect } from "next/navigation";

export default async function DiaryNotePage({ params }: { params: Promise<{ date: string }> }) {
    ...
    const { data: note } = await getDiaryNote(date);
